...
abstract class ThemeX {
  ...
  static ThemeX of(BuildContext context) =>
...
class LightModeTheme extends ThemeX {
  Color? primaryColor = const Color(0xFF54B2CF);
...
class DarkModeTheme extends ThemeX {
  Color? primaryColor = const Color(0xFF54B2CF);
  Color? secondaryColor = const Color(0xFF39D2C0);
  Color? tertiaryColor = const Color(0xFFEE8B60);
  Color? alternate = const Color(0xFFFF5963);
